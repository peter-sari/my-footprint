...
def register():
    ...
    if request.method == "POST":
        ...
        if len(rows) != 0 :
            ...
            db.execute("INSERT INTO dim_user (username, birth_year, country, password_hash) VALUES(%s, %s, %s, %s)", (username, birth_year, country, generate_password_hash(request.form.get("password"),)))
